		...
		card: {
			card: {
				...
				info: {
					...
					promoted: true,
					adTrackingId:
						"cid=28456496~p=0~adgrpid=28456496#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=994419~plpr=COLLECTION~eid=ebd918e6-9f1b-4088-a56b-615608a7fbca~srvts=1747767648714~collid=83639",
					sla: {
						deliveryTime: 28,
						lastMileTravel: 5,
		...
		card: {
			card: {
				...
				info: {
					...
					promoted: true,
					adTrackingId:
						"cid=29325162~p=6~adgrpid=29325162#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=1007933~plpr=COLLECTION~eid=c2c84962-6f94-4da9-a82b-f1f62960094f~srvts=1747767648714~collid=83639",
					sla: {
						deliveryTime: 26,
						lastMileTravel: 5,
						serviceability: "SERVICEABLE",
		...
		card: {
			card: {
				...
				info: {
					...
					promoted: true,
					adTrackingId:
						"cid=29325154~p=7~adgrpid=29325154#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=1004721~plpr=COLLECTION~eid=7e7d7b38-70f8-4fa8-83fc-c9f83d4f212c~srvts=1747767648714~collid=83639",
					sla: {
						deliveryTime: 28,
						lastMileTravel: 5,
						serviceability: "SERVICEABLE",
		...
		card: {
			card: {
				...
				info: {
					...
					cuisines: ["Biryani", "Chinese", "Andhra", "Tandoor"],
					avgRating: 4,
					parentId: "230716",
					avgRatingString: "4.0",
		...
		card: {
			card: {
				...
				info: {
					...
					promoted: true,
					adTrackingId:
						"cid=29190444~p=10~adgrpid=29190444#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=139558~plpr=COLLECTION~eid=99974e63-d0db-4a8c-b61e-d4dfe6f0910c~srvts=1747767648714~collid=83639",
					sla: {
						deliveryTime: 30,
						lastMileTravel: 4.5,
						serviceability: "SERVICEABLE",
